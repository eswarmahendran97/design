...
module.exports = {
    ...
    plugins: [
        ...
        new ModuleFederationPlugin({
            name: "RootApp",  // This application named 'Home'
            ...
            remotes: {
                "ExternalMf": "ExternalUserApp@http://localhost:3003/remoteEntry.js",  
                "InternalMf": "InternalUserApp@http://localhost:3004/remoteEntry.js",  
            },
            shared: {
                ...dependencies,
                react: {
